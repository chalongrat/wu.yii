            ...
            <div class="card-body">
                ...
                <div class="card" style="overflow-x: auto;">
                    <div class="card-body">
                        ...
                        <table id="tbSubresformoth" class="table table-striped table-bordered dt-responsive" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th class="text-center" name="subres_1"></th>
                                    <th class="text-center" name="subres_2"></th>
                                    <th class="text-center" name="subres_3"></th>
                                    <th class="text-center" name="subres_4"></th>
                                    <th class="text-center" name="subres_5"></th>
                                    <th class="text-center" name="subres_6"></th>
                                    <th class="text-center" name="subres_7"></th>
                                </tr>
                            </thead>
                        </table>
...
<script>
    loadScript(["/app/subresformoth/subresformoth.js"], function() {
        loadData("<?= $formType ?>");
    });
</script>